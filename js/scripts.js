...
$(document).ready(function () {
    ...
    if ((pizzaSize == "") && (pizzaCrust == "")) {
        ...
        $("#information").show();
        $("div.ordered").hide();
        alert("Please select the size  and the crust");
    } else {
        $("button#make").hide();
        $("#information").hide();
    ...
    $("button#cart").click(function () {
        ...
        var newOrder = new Pizza(flavor, pizzaSize, pizzaCrust, pizzaToppings, total);

        $("#make").append('<tr><td id="pizzaFlavor">' + newOrder.flavor + '</td><td id="pizzaSize">' + newOrder.size + '</td><td id="pizzaCrust">' + newOrder.crust + '</td><td id="pizzaTopping">' + newOrder.topping + '</td><td id="totals">' + newOrder.total + '</td></tr>');
